    ...
    <div class="hero-slider">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide" style="background-image: url('/media/img/aspirasipartisipasi_hero1.jpg');"></div>
                <div class="swiper-slide" style="background-image: url('/media/img/aspirasipartisipasi_hero2.jpg');"></div>
                <div class="swiper-slide" style="background-image: url('/media/img/aspirasipartisipasi_hero3.jpg');"></div>
            </div>
            <!-- Add Pagination -->
