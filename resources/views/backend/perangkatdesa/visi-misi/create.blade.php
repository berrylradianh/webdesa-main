...
@section('content')
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-md">
        <h2 class="text-2xl font-bold mb-6 border-b pb-2">Tambah Visi & Misi</h2>

        <form action="{{ route('perangkat.visi-misi.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div class="mb-4">
                ...
                <textarea name="visi" rows="4"
                    class="w-full border-2 border-gray-300 rounded-lg p-2 focus:outline-none focus:border-blue-500">{{ old('visi') }}</textarea>
