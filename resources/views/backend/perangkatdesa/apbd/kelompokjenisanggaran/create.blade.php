...
@section('page-title', 'Tambah Kelompok Jenis Anggaran')

@section('content')
<div class="max-w-5xl mx-auto bg-white p-8 rounded-2xl shadow-lg mt-8">
    <h2 class="text-3xl font-bold text-gray-800 mb-6 border-b-2 border-gray-200 pb-3">Tambah Kelompok Jenis Anggaran</h2>

    <form action="{{ route('group_budget_types.store') }}" method="POST" class="space-y-6">
        @csrf
